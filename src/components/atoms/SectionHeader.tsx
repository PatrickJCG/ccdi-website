  ...
  return (
    ...
    >
      ...
      <HeadingTag className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight font-heading leading-tight">
        ...
        <span className="block mt-2 h-1 w-12 rounded-full bg-gradient-to-r from-industrial_blue-700 via-industrial_blue-500 to-construction_gold-500 opacity-80" style={{ margin: align === 'center' ? '0.5rem auto 0' : '0.5rem 0 0' }} />
      </HeadingTag>
      {description && (
