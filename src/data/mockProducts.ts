...
import { POULTRY_BREEDER_ACCESSORIES } from './poultryBreederAccessories';
export { POULTRY_BREEDER_ACCESSORIES };
...
export const BU_META: Record<BusinessUnit, { icon: string; color: string; coverImage: string; description: string; subCategories: string[] }> = {
  'Poultry Farm Equipment': {
    ...
    subCategories: [
      'All',
      'Housing & Structure',
      'Feeding Equipment & Silos',
      'Drinking & Water Pretreatment',
      'Slatted Flooring Accessories',
      'Nesting System Accessories',
      'Climate Control & Automation',
      'Lighting & Supplementary Heating',
    ],
  },
  'Hatchery': {
    icon: 'Egg',
...
export const MOCK_PRODUCTS: Product[] = [
  ...
  // ─── POULTRY BREEDING OPERATIONS (OFFICIAL BROCHURE SPECIFICATIONS) ───────
  {
    id: 'pf-breeder-01',
    title: 'American Type Breeder House (1/3 Slat)',
    badge: 'Breeder Housing',
    businessUnit: 'Poultry Farm Equipment',
    subCategory: 'Housing & Structure',
    category: 'Poultry Facilities',
    functionCategory: 'Civil & Structural Construction',
    speciesTags: ['Broiler Breeder', '1/3 Slat', 'Lateral Nests', 'Central Mating'],
    description: 'A breeding housing system with nest boxes arranged in two rows along both sides of the building and a central mating area that allows free movement, natural mating, and improved bird distribution.',
    imageUrl: '/images/breeder/american-type-3d.png',
    videoUrl: '/videos/poultry-breeding-american.mp4',
    metrics: { spec1Label: 'Slat Floor', spec1Value: '1/3 Slat Design', spec2Label: 'Dimensions', spec2Value: '14m x 134m x 2.9m', spec3Label: 'Bird Capacity', spec3Value: '9,900 F / 990 M' },
    buildingSpecs: {
      buildingType: 'Pre-fabricated House',
      dimensions: '14m x 134m x 2.9m',
      birdCapacity: '9,900 Female · 990 Male (10,890 Total)',
      features: [
        'Nest boxes in 2 rows along both sides',
        'Central mating scratch area',
        'Free bird movement & natural mating',
        '1/3 elevated slatted floor',
        'Optimized flock distribution',
      ],
    },
    materials: {
  ...
  {
    id: 'pf-breeder-02',
    title: 'European Type Breeder House (2/3 Slat)',
    badge: 'Breeder Housing',
    businessUnit: 'Poultry Farm Equipment',
    subCategory: 'Housing & Structure',
    category: 'Poultry Facilities',
    functionCategory: 'Civil & Structural Construction',
    speciesTags: ['Broiler Breeder', '2/3 Slat', 'Center Community Nest', 'High Density'],
    description: 'A breeding housing system that uses group or community nests arranged in a single row at the center, with mating areas at both ends of the building to improve space efficiency, egg collection, and production consistency.',
    imageUrl: '/images/breeder/euro-style-3d.png',
    videoUrl: '/images/breeder/Poultry_breeding_house_EURO.mp4',
    metrics: { spec1Label: 'Slat Floor', spec1Value: '2/3 Slat Design', spec2Label: 'Dimensions', spec2Value: '14m x 134m x 2.9m', spec3Label: 'Bird Capacity', spec3Value: '9,900 F / 990 M' },
    buildingSpecs: {
      buildingType: 'Pre-fabricated House',
      dimensions: '14m x 134m x 2.9m',
      birdCapacity: '9,900 Female · 990 Male (10,890 Total)',
      features: [
        'Single center row community/group nests',
        'Mating areas at both ends of the building',
        'Rapid centralized egg collection',
        '2/3 elevated slatted floor',
        'Superior space efficiency & production consistency',
      ],
    },
    materials: {
      mainStructure: ['Q355B Welding and hot rolling H steel', 'Shot blasting (SA2.5)', 'Antirusting paint (Grey)'],
  ...
  {
    id: 'pf-breeder-03',
    title: 'Breeder Nesting System',
    badge: 'Egg Collection',
    businessUnit: 'Poultry Farm Equipment',
    subCategory: 'Automation',
    category: 'Poultry Facilities',
    functionCategory: 'Equipment & Automation',
    speciesTags: ['Conventional Nests', 'Single Automatic', 'Group Automatic'],
    description: 'An egg-laying system for clean, efficient, and reliable egg collection, with configurations from manual to fully automated.',
    imageUrl: 'https://images.unsplash.com/photo-1548550023-2bdb3c5beed7?auto=format&fit=crop&w=800&q=80',
    metrics: { spec1Label: 'Collection', spec1Value: 'Manual / Automated', spec2Label: 'Egg Quality', spec2Value: 'Clean Collection', spec3Label: 'Configurations', spec3Value: 'Single / Group' },
    buildingSpecs: {
      features: [
        'Conventional Nests',
        'Single Automatic Nests',
        'Group Automatic Community Nests',
        'Automated egg transfer belts',
        'Gentle egg de-escalation',
      ],
    },
    isBrochureSpec: true,
    isSample: false,
  ...
  // ─── POULTRY FARM EQUIPMENT (EXACT DATA FROM BROCHURES) ───────────────────
  {
    ...
    category: 'Poultry Facilities',
    functionCategory: 'Civil & Structural Construction',
    speciesTags: ['Broiler', 'Multi-Tier Cage', 'Automated Harvest', 'Manure Removal'],
    description: 'An intensive poultry housing solution designed to maximize vertical space through the use of multi-tier cages. It features integrated systems for feeding, drinking, ventilation, and manure removal, with options for manual or automatic harvesting systems.',
    imageUrl: '/images/broiler/multi-tier-broiler.jpg',
    metrics: { spec1Label: 'Building Type', spec1Value: 'Prefabricated House', spec2Label: 'Dimensions', spec2Value: '16m x 110m x 4m–4.2m', spec3Label: 'Bird Capacity', spec3Value: '80,000 @ 1.8kg' },
    buildingSpecs: {
      buildingType: 'Prefabricated House',
      dimensions: '16m x 110m x 4m–4.2m',
      birdCapacity: '80,000 @ 1.8kg',
      features: [
        'Maximize Vertical Space (Multi-Tier Cages)',
        'Integrated Feeding, Drinking, Ventilation & Manure Removal',
        'Manual or Automatic Harvesting Systems',
        'High-Density Commercial Broiler Production',
      ],
    },
    materials: {
      mainStructure: ['Q355B Welding and hot rolling H steel', 'Shot blasting (SA2.5)', 'Antirusting paint (Grey)'],
  ...
  },
  {
    ...
    category: 'Poultry Facilities',
    functionCategory: 'Civil & Structural Construction',
    speciesTags: ['Broiler', 'Elevated Floor', 'Airflow', 'Hygiene'],
    description: 'A broiler housing system utilizing a raised floor design that improves bird manure management, environmental airflow, and internal hygiene.',
    imageUrl: '/images/broiler/elevated-floor-broiler.jpg',
    metrics: { spec1Label: 'Building Type', spec1Value: 'Prefabricated House', spec2Label: 'Dimensions', spec2Value: '18m x 156m x 2.4m', spec3Label: 'Bird Capacity', spec3Value: '55,000 @ 1.8kg' },
    buildingSpecs: {
      buildingType: 'Prefabricated House',
      dimensions: '18m x 156m x 2.4m',
      birdCapacity: '55,000 @ 1.8kg',
      features: ['Raised Floor Design', 'Manure Management', 'Environmental Airflow & Internal Hygiene'],
    },
    materials: {
      mainStructure: ['Q355B Welding and hot rolling H steel', 'Shot blasting (SA2.5)', 'Antirusting paint (Grey)'],
      secondaryStructure: ['Wind Stand: 200-280kph', 'Q235B round steel/circular tube/angle iron (including ceiling joist)'],
  ...
  },
  {
    ...
    category: 'Poultry Facilities',
    functionCategory: 'Civil & Structural Construction',
    speciesTags: ['Broiler', 'Floor-Type', 'Controlled Environment', 'Ground-Level'],
    ...
    metrics: { spec1Label: 'Building Type', spec1Value: 'Prefabricated House', spec2Label: 'Dimensions', spec2Value: '16m x 138m x 2.4m', spec3Label: 'Bird Capacity', spec3Value: '36,000 @ 1.8kg' },
    buildingSpecs: {
      buildingType: 'Prefabricated House',
  ...
  },
  {
    ...
    category: 'Poultry Facilities',
    functionCategory: 'Civil & Structural Construction',
    speciesTags: ['Layer', 'Commercial Layer', 'H-Frame', 'Automated Egg Collection', 'Manure Belt'],
    description: 'A high-density system featuring cages vertically stacked on a rigid H-shaped structure, designed for efficient, large-scale production. It features fully integrated systems for feeding, drinking, egg collection, ventilation, and manure-belt removal. A standard 45,000-bird setup utilizes a prefabricated house dimension of 97m x 10m x 4.3m, with cages holding 36 birds each at a density of 450 sq cm per bird.',
    imageUrl: '/images/capabilities/poultry-facility.jpg',
    metrics: { spec1Label: 'Building Type', spec1Value: 'Prefabricated House', spec2Label: 'Dimensions', spec2Value: '97m x 10m x 4.3m', spec3Label: 'Bird Capacity', spec3Value: '45,000 Birds (36/Cage)' },
    buildingSpecs: {
      buildingType: 'Prefabricated House',
      dimensions: '97m x 10m x 4.3m',
      birdCapacity: '45,000 Birds (36 Birds/Cage @ 450 cm²/Bird)',
      features: [
        'Rigid H-shaped vertical cage stack structure',
        '36 birds per cage partition (450 sq cm / bird)',
        'Integrated automated feeding, drinking & ventilation',
        'Continuous longitudinal manure-belt removal',
        'Synchronized automated egg collection elevators',
      ],
    },
    materials: {
      mainStructure: ['Q355B Welding and hot rolling H steel', 'Shot blasting (SA2.5)', 'Antirusting paint (Grey)'],
      ...
      roofPurlin: ['Galvanized cold-rolled steel', 'C-purlins'],
      wallPurlin: ['Galvanized cold-rolled steel', 'C-purlins'],
      roofSheet: ['V840 color single steel roof sheet', 'T= 0.4mm, 0.5mm, 0.6mm'],
      ceilingSheet: ['V900 steel ceiling sheet', 'T= 0.37mm'],
      ceilingInsulation: ['Fiberglass roll (W=1.15m, T= 100mm, D=16kg/m³)', 'Polyethylene Sheet'],
      wallPanel: ['PPGI V1000 PU sandwich panel', 'T=0.4mm+50mm+0.4mm, D=40 ±2kg/m³'],
    },
    isBrochureSpec: true,
  ...
  },
  {
    ...
    category: 'Poultry Facilities',
    functionCategory: 'Civil & Structural Construction',
    speciesTags: ['Layer', 'Commercial Layer', 'A-Frame', 'Natural Ventilation', 'Easy Inspection'],
    description: 'A multi-tier system with an open, sloped "A" configuration that facilitates better ventilation, easy inspection, and straightforward maintenance. It provides individual compartments equipped with feed troughs, nipple drinkers, egg-collection channels, and dedicated manure disposal space beneath each tier. A standard 30,000-bird setup requires a building dimension of 133m x 13m x 3.5m, with cages holding 20 birds each at a density of 450 sq cm per bird.',
    imageUrl: 'https://images.unsplash.com/photo-1548550023-2bdb3c5beed7?auto=format&fit=crop&w=800&q=80',
    metrics: { spec1Label: 'Building Type', spec1Value: 'Prefabricated House', spec2Label: 'Dimensions', spec2Value: '133m x 13m x 3.5m', spec3Label: 'Bird Capacity', spec3Value: '30,000 Birds (20/Cage)' },
    buildingSpecs: {
      buildingType: 'Prefabricated House',
      dimensions: '133m x 13m x 3.5m',
      birdCapacity: '30,000 Birds (20 Birds/Cage @ 450 cm²/Bird)',
      features: [
        'Open, sloped "A" frame multi-tier configuration',
        '20 birds per cage partition (450 sq cm / bird)',
        'Individual compartments with feed troughs & nipple drinkers',
        'Egg-collection channels & dedicated manure space beneath each tier',
        'Superior airflow ventilation & straightforward maintenance',
      ],
    },
    materials: {
      mainStructure: ['Q355B Welding and hot rolling H steel', 'Shot blasting (SA2.5)', 'Antirusting paint (Grey)'],
  ...
  // ─── POULTRY BREEDER EQUIPMENT & ACCESSORIES (OFFICIAL PRODUCT LINE) ────
  ...POULTRY_BREEDER_ACCESSORIES,
